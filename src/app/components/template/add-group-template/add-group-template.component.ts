...
import {PostGroupTemplate} from "../../../models/groupTemplate/PostGroupTemplate";
 ...
 @Component({
   ...
   standalone: true,
   imports: [CommonModule, FormsModule, ReactiveFormsModule, MatDialogTitle, MatDialogContent, MatFormField, MatInput, MatSelect, MatOption, MatDialogActions,],
 ...
 export class AddGroupTemplateComponent {
   ...
   constructor(
     ...
     save() {
       let groupTemplate:PostGroupTemplate={
         acronym:this.acronym.value!,
         title:this.title.value!,
         description:this.description.value!,
         numberOfDates:this.numberOfDates.value!,
         duration:this.duration.value!,
         participantsPerTrainer:this.numberOfParticipants.value!,
